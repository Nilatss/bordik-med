...
export const CATALOG_TOOLS: CatalogTool[] = [
  ...
  T('henderson', 'Henderson-Hasselbalch / Winter / Stewart', 'Анализ кислотно-щелочного состояния и компенсации.', '1. Клинические калькуляторы', 'Электролиты / КЩС'),
  T('aa-gradient', 'A-a gradient / P/F ratio / SF / OI', 'Оценка газообмена и тяжести дыхательной недостаточности.', '1. Клинические калькуляторы', 'Электролиты / КЩС'),
  ...
  T('wells-dvt', 'Wells DVT / Wells PE', 'Предтестовая вероятность ТГВ и ТЭЛА.', '2. Диагностические шкалы', 'ВТЭ / Кровотечение', true),
  ...
  T('silverman', 'Silverman-Anderson', 'Оценка тяжести респираторного дистресс-синдрома у новорождённого.', '3. Педиатрические инструменты', 'Новорождённые'),
  T('downes', 'Downes score', 'Альтернативная оценка дыхательной недостаточности у новорождённых.', '3. Педиатрические инструменты', 'Новорождённые'),
  T('ballard', 'Ballard / New Ballard Score', 'Определение гестационного возраста после рождения.', '3. Педиатрические инструменты', 'Новорождённые'),
  T('dubowitz', 'Dubowitz', 'Классическая шкала оценки гестационного возраста.', '3. Педиатрические инструменты', 'Новорождённые'),
  T('finnegan', 'Finnegan NAS/FNAS', 'Оценка синдрома неонатальной абстиненции.', '3. Педиатрические инструменты', 'Новорождённые'),
  T('thompson', 'Thompson Score / Sarnat staging', 'Оценка тяжести гипоксически-ишемической энцефалопатии.', '3. Педиатрические инструменты', 'Новорождённые'),
  T('kramer', 'Kramer scale / Bhutani nomogram', 'Оценка желтухи и показаний к фототерапии у новорождённого.', '3. Педиатрические инструменты', 'Новорождённые'),
  T('crib', 'CRIB-II / SNAP-II / SNAPPE-II', 'Оценка тяжести состояния в неонатальной реанимации.', '3. Педиатрические инструменты', 'Новорождённые'),
  ...
  T('intergrowth', 'Интергроуз-21 / Fenton chart', 'Кривые роста для недоношенных и после рождения.', '3. Педиатрические инструменты', 'Рост и развитие'),
  ...
  T('hunt-hess', 'Hunt-Hess / Fisher / modified Fisher / WFNS / PAASH', 'Тяжесть и прогноз субарахноидального кровоизлияния.', '5. Неврология и нейрохирургия', 'Инсульт'),
  ...
  T('ranson', 'Ranson / Glasgow-Imrie / APACHE II / BISAP / HAPS', 'Оценка тяжести и прогноза острого панкреатита.', '7. Травматология и военная медицина', 'Неотложная хирургия'),
  ...
  T('rockall', 'Rockall / Glasgow-Blatchford / AIMS65', 'Оценка риска при кровотечении из верхних отделов ЖКТ.', '7. Травматология и военная медицина', 'Неотложная хирургия'),
  ...
  T('maddrey', 'Maddrey DF / Lille / ABIC / GAHS', 'Оценка тяжести алкогольного гепатита и ответа на ГКС.', '7. Травматология и военная медицина', 'Неотложная хирургия'),
  ...
  T('cage-audit', 'CAGE / AUDIT / AUDIT-C / MAST / T-ACE', 'Скрининг проблемного употребления алкоголя.', '9. Психиатрия и психология', 'Зависимости'),
  ...
  T('npi', 'Nottingham Prognostic Index (NPI)', 'Прогностический индекс при раке молочной железы.', '10. Онкология', 'Специфические'),
  ...
  T('aa-grad', 'A-a gradient', 'Оценка эффективности газообмена в лёгких.', '15. Лабораторная медицина', 'Газы крови'),
