...
const runner: ScoreTool = {
  ...
  bands: [
    {
      min: 0, max: 0, label: 'C0', color: '#22C55E',
    ...
    {
      min: 1, max: 1, label: 'C1', color: '#84CC16',
    ...
    {
      min: 2, max: 2, label: 'C2', color: '#F59E0B',
    ...
    {
      min: 4, max: 4, label: 'O1', color: '#F59E0B',
    ...
    {
      min: 5, max: 5, label: 'O2', color: '#F97316',
    ...
    {
      min: 6, max: 6, label: 'O3', color: '#EF4444',
