...
const runner: CalculatorTool = {
  ...
  compute: (v) => {
    ...
    const map: Record<string, { name: string; main: string; url: string; details: string; actions: string[]; caveats: string[] }> = {
      sg: {
        name: 'Сингапур',
        ...
        actions: [
          'MOH CPGs: https://www.moh.gov.sg/hpp/all-healthcare-professionals/guidelines',
          'Academy of Medicine Singapore: https://www.ams.edu.sg/',
          'HSA (регулятор лекарств): https://www.hsa.gov.sg/',
          'College of Family Physicians Singapore: https://www.cfps.org.sg/',
        ],
        caveats: [
          'MediShield Life / MediSave — национальная схема финансирования',
          'English — официальный клинический язык',
          'HSA регулирует лекарства отдельно от США/ЕС (но часто взаимно признаёт)',
          'Healthier SG (primary care reform 2023) — регистрация у семейного врача',
        ],
      },
      my: {
        name: 'Малайзия',
        ...
        actions: [
          'KKM CPG portal: https://www.moh.gov.my/index.php/pages/view/195',
          'MyHealth (patient info): http://www.myhealth.gov.my/',
          'MMC (Medical Council): https://mmc.gov.my/',
          'NPRA (лекарства): https://www.npra.gov.my/',
        ],
        caveats: [
          'HLA-B*15:02 скрининг перед carbamazepine — обязателен у малайцев/китайцев',
          'Дуальная система: public KKM + private hospitals',
          'Bahasa Malaysia — официально, но CPG в основном English',
          'G6PD screening — обязателен для новорождённых',
        ],
      },
      th: {
        name: 'Таиланд',
        ...
        actions: [
          ...
          'Royal College of Physicians Thailand (RCPT): https://www.rcpt.org/',
          'NHSO (UCS): https://eng.nhso.go.th/',
          'Thai FDA: https://en.fda.moph.go.th/',
        ],
        caveats: [
          'HLA-B*15:02 — высокая частота у Thai → обязательный скрининг перед carbamazepine',
          'UCS (30-baht scheme) покрывает ~75% населения',
          'Melioidosis (B. pseudomallei) — endemic на севере/северо-востоке',
          'National Essential Drug List — основа реимбурсации в UCS',
        ],
      },
      id: {
        name: 'Индонезия',
        ...
        actions: [
          'Kemenkes portal: https://www.kemkes.go.id/',
          'BPJS Kesehatan: https://bpjs-kesehatan.go.id/',
          'PERKI (cardiology): https://www.inaheart.org/',
          'PERKENI (endo): https://pbperkeni.or.id/',
          'BPOM (лекарства): https://www.pom.go.id/',
        ],
        caveats: [
          'JKN-BPJS — универсальное страхование с 2014, формуляр Fornas',
          'Gatekeeping: Puskesmas (первичное звено) → specialist',
          'Документы на Bahasa Indonesia — переводы редки',
          'Региональная фрагментация: Java vs outer islands',
        ],
      },
      ph: {
        name: 'Филиппины',
        ...
        actions: [
          'DOH portal: https://doh.gov.ph/',
          'PhilHealth: https://www.philhealth.gov.ph/',
          'Philippine Heart Association: https://philheart.org/',
          'Philippine Pediatric Society: https://pps.org.ph/',
          'FDA Philippines: https://www.fda.gov.ph/',
        ],
        caveats: [
          'Universal Health Care Act (2019) — автоматическая регистрация в PhilHealth',
          'Dengue endemic + tropical cyclones — disaster preparedness в протоколах',
          'TB burden — один из высочайших в ASEAN (NTP)',
          'Английский — основной клинический язык',
        ],
      },
      vn: {
        name: 'Вьетнам',
        ...
        actions: [
          ...
          'VSS (social insurance): https://vss.gov.vn/',
          'DAV (Drug Administration of Vietnam): https://dav.gov.vn/',
          'Vietnam Heart Association: http://vnha.org.vn/',
        ],
        caveats: [
          'Документы на vietnamese — английские переводы редки',
          'VHI (Vietnam Health Insurance) — >90% покрытие',
          'HBV endemic — вакцинация при рождении стандарт',
          'Tiered referral: commune → district → provincial → central',
        ],
      },
      asean: {
        name: 'ASEAN-level',
        ...
        actions: [
          'ASEAN Health: https://asean.org/our-communities/asean-socio-cultural-community/health/',
          'ASEAN MRA on Medical Practitioners: https://asean.org/',
          'ASEAN Post-2025 Health Development Agenda (ASCC)',
          'ASEAN Emergency Public Health System',
        ],
        caveats: [
          'ASEAN MRA — требует национального license в принимающей стране',
          'AHC1–4 — координация, но регуляция национальная',
          'COVID-19 показал необходимость ASEAN Centre for Public Health Emergencies (ACPHEED)',
          'Языковая фрагментация сохраняется',
        ],
      },
    };
    const e = map[c]!;
    return {
      ...
      actions: [
        ...e.actions,
        '— Общие источники ASEAN —',
        'ASEAN Health Cluster: https://asean.org/our-communities/asean-socio-cultural-community/health/',
        'WHO WPRO: https://www.who.int/westernpacific',
        'WHO SEARO: https://www.who.int/southeastasia',
      ],
      caveats: [
        ...e.caveats,
        '— Общие для ASEAN —',
        'Высокая эндемичность: dengue, TB, malaria (регионально), melioidosis, leptospirosis',
        'HLA-B*15:02 — carbamazepine SJS в Han Chinese / Thai / Malay',
