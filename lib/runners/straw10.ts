...
const runner: ScoreTool = {
  ...
  bands: [
    { min: 0, max: 0, label: 'Репродуктивный период', color: '#22C55E', description: 'FSH, АМГ - нормальные; регулярная овуляция.', actions: ['Рутинная гинекологическая помощь'] },
    { min: 1, max: 1, label: '−2 Поздний репродуктивный', color: '#86EFAC', description: 'Лёгкое сокращение фолликулярной фазы, снижение АМГ, рост FSH.', actions: ['При планировании беременности - обсудить криоконсервацию'] },
    { min: 2, max: 2, label: '−1 Ранняя MT', color: '#F59E0B', description: 'Вариация длины цикла ≥ 7 дней ≥ 2 раз в 10 циклах. FSH вариабельно повышен.', actions: ['Обсудить контрацепцию', 'Оценить вазомоторные симптомы'] },
    { min: 3, max: 3, label: '+1a Поздняя MT', color: '#F59E0B', description: 'Аменорея ≥ 60 дней; до FMP < 1-3 лет.', actions: ['Симптоматическое лечение', 'МГТ при выраженных симптомах'] },
    { min: 4, max: 4, label: '+1b Ранняя постменопауза (1-2 г)', color: '#EF4444', description: 'FSH стабильно > 30 МЕ/л; пик симптомов.', actions: ['МГТ - терапевтическое окно', 'Скрининг остеопороза (DXA)'] },
    { min: 5, max: 5, label: '+1c Ранняя постменопауза (3-6 г)', color: '#EF4444', description: 'Сохраняется высокая активность симптомов.', actions: ['Продолжить МГТ по показаниям', 'Оценка кардиоваскулярного риска'] },
    { min: 6, max: 6, label: '+2 Поздняя постменопауза', color: '#DC2626', description: '> 6 лет после FMP; атрофические процессы.', actions: ['Локальные эстрогены при GSM', 'FRAX / DXA; кардиоваскулярный скрининг'] },
  ],
  reference:
