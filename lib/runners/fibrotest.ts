...
const runner: CalculatorTool = {
  ...
  inputs: [
    { id: 'a2m',
hint: 'Концентрация в г/л', label: 'α2-макроглобулин', type: 'number', unit: 'г/л', min: 0.5, max: 6, step: 0.01, quickValues: [1.5, 2.0, 2.5, 3.5] },
    { id: 'hapto',
hint: 'Концентрация в г/л', label: 'Гаптоглобин', type: 'number', unit: 'г/л', min: 0, max: 5, step: 0.01, quickValues: [0.5, 1.0, 1.5, 2.0] },
    { id: 'apoa1',
hint: 'Концентрация в г/л', label: 'Аполипопротеин A1', type: 'number', unit: 'г/л', min: 0.5, max: 3, step: 0.01, quickValues: [1.0, 1.3, 1.6] },
    { id: 'bili',
hint: 'Билирубин общий. Норма: 5-21 мкмоль/л', label: 'Билирубин общий', type: 'number', unit: 'мкмоль/л', min: 3, max: 500, quickValues: [10, 20, 50, 150] },
    { id: 'ggt',
hint: 'ГГТ. Норма: М <55, Ж <38 Ед/л', label: 'ГГТ', type: 'number', unit: 'Ед/л', min: 5, max: 2000, quickValues: [30, 80, 200, 500] },
    { id: 'alt',
hint: 'АЛТ. Норма: М <40, Ж <32 Ед/л', label: 'АЛТ', type: 'number', unit: 'Ед/л', min: 5, max: 2000, quickValues: [25, 60, 120] },
    { id: 'age',
hint: 'Возраст в годах', label: 'Возраст', type: 'number', unit: 'лет', min: 18, max: 100, quickValues: [30, 50, 65] },
