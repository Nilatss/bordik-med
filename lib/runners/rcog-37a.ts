...
const runner: ScoreTool = {
  ...
  bands: [
    { min: 0, max: 1, label: 'Низкий риск', color: '#22C55E', interpretation: 'Ранняя мобилизация, адекватная гидратация.', actions: ['Без фармакопрофилактики', 'Повторная оценка при изменении клиники'] },
    { min: 2, max: 2, label: 'Промежуточный риск', color: '#F59E0B', interpretation: 'Антенатально: мобилизация/гидратация. Постнатально: ≥ 2 - LMWH ≥ 10 дней.', actions: ['Постнатально LMWH ≥ 10 дней при сумме ≥ 2', 'Компрессионный трикотаж как дополнение'] },
    { min: 3, max: 3, label: 'Высокий риск', color: '#EF4444', interpretation: 'Антенатально: LMWH с 28 нед. Постнатально: LMWH ≥ 10 дней (до 6 нед при высоком риске).', actions: ['LMWH в профилактической дозе (enoxaparin 40 мг/сут ± коррекция по массе)', 'Учитывать функцию почек'] },
    { min: 4, max: 20, label: 'Очень высокий риск', color: '#DC2626', interpretation: 'Антенатально: LMWH с I триместра. Постнатально: LMWH 6 нед.', actions: ['Профилактическая или промежуточная доза LMWH', 'Консультация гематолога при APS / тромбофилиях', 'Компрессионный трикотаж'] },
  ],
  reference:
