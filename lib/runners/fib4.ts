...
const runner: CalculatorTool = {
  ...
  inputs: [
    ...
    { id: 'age', label: 'Возраст (лет)', type: 'number', min: 18, max: 100, step: 1, quickValues: [35, 50, 65] },
    { id: 'ast', label: 'AST (U/L)', type: 'number', min: 5, max: 500, step: 1, quickValues: [20, 40, 80, 150] },
    { id: 'alt', label: 'ALT (U/L)', type: 'number', min: 5, max: 500, step: 1, quickValues: [25, 45, 90] },
    { id: 'plt', label: 'Тромбоциты (×10⁹/л)', type: 'number', min: 20, max: 500, step: 1, quickValues: [100, 150, 250] },
