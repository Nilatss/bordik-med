...
const runner: CalculatorTool = {
  ...
  inputs: [
    ...
    { id: 'urea_pre', label: 'Мочевина до (HD) / урея в крови (PD)', type: 'number', unit: 'ммоль/л', min: 1, max: 60, step: 0.1, quickValues: [20, 25, 30] },
    { id: 'urea_post', label: 'Мочевина после HD', type: 'number', unit: 'ммоль/л', min: 0.5, max: 40, step: 0.1, quickValues: [6, 8, 10] },
    { id: 'duration', label: 'Длительность сеанса HD', type: 'number', unit: 'ч', min: 1, max: 8, step: 0.25, quickValues: [3.5, 4, 4.5] },
    { id: 'uf', label: 'Ультрафильтрация (снижение веса)', type: 'number', unit: 'л', min: 0, max: 6, step: 0.1, quickValues: [1, 2, 3] },
    { id: 'weight', label: 'Вес после (сухой)', type: 'number', unit: 'кг', min: 30, max: 200, step: 0.5, quickValues: [60, 70, 85] },
    { id: 'pd_volume', label: 'Недельный дренаж (PD)', type: 'number', unit: 'л/нед', min: 20, max: 200, step: 1, quickValues: [60, 80, 100] },
    { id: 'pd_urea_d', label: 'Мочевина диализата (PD)', type: 'number', unit: 'ммоль/л', min: 1, max: 60, step: 0.1, quickValues: [15, 20, 25] },
    { id: 'pd_v', label: 'Объём распределения V (PD)', type: 'number', unit: 'л', min: 20, max: 60, step: 0.5, quickValues: [35, 40, 45] },
  ],
  compute: (v) => {
...
### Источник
KDOQI 2015 HD Adequacy; ISPD 2020 Adequacy Guidelines.`,
};
