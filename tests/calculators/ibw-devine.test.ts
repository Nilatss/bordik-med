/**
 * Golden tests for calculator runner 'ibw-devine'.
 *
...
describe('ibw-devine · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ height: 170 }) as CalculatorResult | null;
