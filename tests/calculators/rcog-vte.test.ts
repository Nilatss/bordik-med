/**
 * Golden tests for runner 'rcog-vte'.
 *
 ...
 *
 * Score range: 0..20, 4 bands.
 */
import { describe, it, expect } from 'vitest';
import runner from '@/lib/runners/rcog-vte';
import { findBand, type ScoreBand } from '@/lib/tools-runners';

const bands = (runner as { bands: ScoreBand[] }).bands;

describe('rcog-vte · bands', () => {
  ...
  it('highest band (score 20) → label matches "4"', () => {
