/**
 * Golden tests for calculator runner 'dka'.
 *
...
describe('dka · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ weight: 102 }) as CalculatorResult | null;
