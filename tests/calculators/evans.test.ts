/**
 * Golden tests for calculator runner 'evans'.
 *
...
describe('evans · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ frontal: 55, skull: 150 }) as CalculatorResult | null;
