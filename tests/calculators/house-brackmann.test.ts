/**
 * Golden tests for runner 'house-brackmann'.
 *
...
import runner from '@/lib/runners/house-brackmann';
import { findBand, type ScoreBand } from '@/lib/tools-runners';

const bands = (runner as { bands: ScoreBand[] }).bands;

describe('house-brackmann · bands', () => {
  ...
  it('highest band (score 6) → label matches "VI"', () => {
    const b = findBand(bands, 6);
    expect(b.label).toMatch(/VI/i);
  });
