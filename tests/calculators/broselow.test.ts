/**
 * Golden tests for calculator runner 'broselow'.
 *
...
describe('broselow · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ length: 98 }) as CalculatorResult | null;
