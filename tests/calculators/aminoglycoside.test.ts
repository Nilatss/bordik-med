/**
 * Golden tests for calculator runner 'aminoglycoside'.
 *
...
describe('aminoglycoside · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ weight: 115, crcl: 103 }) as CalculatorResult | null;
