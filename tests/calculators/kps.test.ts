 ...
 *
 * Score range: 0..100, 4 bands.
 */
import { describe, it, expect } from 'vitest';
import runner from '@/lib/runners/kps';
...
describe('kps · bands', () => {
  ...
  it('lowest band (score 80) → label matches "80"', () => {
    const b = findBand(bands, 80);
    expect(b.label).toMatch(/80/i);
  });

  it('highest band (score 9) → label matches "0"', () => {
