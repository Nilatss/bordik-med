/**
 * Golden tests for calculator runner 'duke-treadmill'.
 *
...
describe('duke-treadmill · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ time: 13, st: 5 }) as CalculatorResult | null;
