...
import runner from '@/lib/runners/esi';
...
describe('esi · bands', () => {
  ...
  it('lowest band (score 1) → label matches "Уровень"', () => {
    const b = findBand(bands, 1);
    expect(b.label).toMatch(/Уровень/i);
  });

  it('highest band (score 5) → label matches "Уровень"', () => {
