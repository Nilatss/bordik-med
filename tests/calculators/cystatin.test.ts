/**
 * Golden tests for calculator runner 'cystatin'.
 *
...
describe('cystatin · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ cysc: 4.2, age: 64 }) as CalculatorResult | null;
