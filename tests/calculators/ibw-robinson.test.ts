/**
 * Golden tests for calculator runner 'ibw-robinson'.
 *
...
describe('ibw-robinson · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ height: 175 }) as CalculatorResult | null;
