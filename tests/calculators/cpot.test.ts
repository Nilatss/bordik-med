 ...
 *
 * Score range: 0..8, 2 bands.
 */
import { describe, it, expect } from 'vitest';
import runner from '@/lib/runners/cpot';
...
describe('cpot · bands', () => {
  ...
  it('highest band (score 8) → label matches "2"', () => {
    const b = findBand(bands, 8);
    expect(b.label).toMatch(/2/i);
  });
