...
import runner from '@/lib/runners/ats';
...
describe('ats · bands', () => {
  ...
  it('lowest band (score 1) → label matches "ATS"', () => {
    const b = findBand(bands, 1);
    expect(b.label).toMatch(/ATS/i);
  });

  it('highest band (score 5) → label matches "ATS"', () => {
