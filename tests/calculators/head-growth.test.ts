/**
 * Golden tests for calculator runner 'head-growth'.
 *
...
describe('head-growth · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ age: 30, hc: 43, muac: 15 }) as CalculatorResult | null;
