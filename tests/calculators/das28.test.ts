/**
 * Golden tests for calculator runner 'das28'.
 *
...
describe('das28 · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ tjc: 14, sjc: 14, gh: 50 }) as CalculatorResult | null;
