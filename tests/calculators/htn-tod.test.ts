/**
 * Golden tests for runner 'htn-tod'.
 *
 ...
 *
 * Score range: 0..7, 3 bands.
 */
import { describe, it, expect } from 'vitest';
import runner from '@/lib/runners/htn-tod';
import { findBand, type ScoreBand } from '@/lib/tools-runners';

const bands = (runner as { bands: ScoreBand[] }).bands;

describe('htn-tod · bands', () => {
  ...
  it('highest band (score 7) → label matches "2"', () => {
