...
import runner from '@/lib/runners/mgfa';
...
describe('mgfa · bands', () => {
  ...
  it('lowest band (score 1) → label matches "Class"', () => {
    const b = findBand(bands, 1);
    expect(b.label).toMatch(/Class/i);
  });

  it('highest band (score 5) → label matches "Class"', () => {
