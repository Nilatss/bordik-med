/**
 * Golden tests for calculator runner 'friedewald'.
 *
...
describe('friedewald · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ tc: 11, hdl: 2.6, tg: 5.1 }) as CalculatorResult | null;
