/**
 * Golden tests for calculator runner 'bsa-haycock'.
 *
...
describe('bsa-haycock · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ weight: 101, height: 125 }) as CalculatorResult | null;
