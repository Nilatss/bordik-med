/**
 * Golden tests for runner 'kocher'.
 *
 ...
 *
 * Score range: 0..4, 4 bands.
 */
import { describe, it, expect } from 'vitest';
import runner from '@/lib/runners/kocher';
import { findBand, type ScoreBand } from '@/lib/tools-runners';

const bands = (runner as { bands: ScoreBand[] }).bands;

describe('kocher · bands', () => {
  ...
  it('highest band (score 4) → label matches "4"', () => {
