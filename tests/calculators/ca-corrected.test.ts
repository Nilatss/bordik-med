/**
 * Golden tests for calculator runner 'ca-corrected'.
 *
...
describe('ca-corrected · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ ca: 2.8, alb: 35 }) as CalculatorResult | null;
