/**
 * Golden tests for calculator runner 'denver'.
 *
...
describe('denver · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ ageMonths: 36 }) as CalculatorResult | null;
