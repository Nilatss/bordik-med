/**
 * Golden tests for calculator runner 'diamond-forrester'.
 *
...
describe('diamond-forrester · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ age: 65 }) as CalculatorResult | null;
