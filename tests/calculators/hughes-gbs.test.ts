/**
 * Golden tests for runner 'hughes-gbs'.
 *
 ...
 *
 * Score range: 0..6, 6 bands.
 */
import { describe, it, expect } from 'vitest';
import runner from '@/lib/runners/hughes-gbs';
import { findBand, type ScoreBand } from '@/lib/tools-runners';

const bands = (runner as { bands: ScoreBand[] }).bands;

describe('hughes-gbs · bands', () => {
  ...
  it('highest band (score 6) → label matches "6"', () => {
