 ...
 *
 * Score range: 0..12, 3 bands.
 */
import { describe, it, expect } from 'vitest';
import runner from '@/lib/runners/pram';
...
describe('pram · bands', () => {
  ...
  it('highest band (score 12) → label matches "8"', () => {
    const b = findBand(bands, 12);
    expect(b.label).toMatch(/8/i);
  });
  it('bands cover full 0..12 range with no overlaps', () => {
