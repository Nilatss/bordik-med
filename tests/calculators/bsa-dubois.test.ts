/**
 * Golden tests for calculator runner 'bsa-dubois'.
 *
...
describe('bsa-dubois · compute', () => {
  ...
  it('compute returns a result for mid-range inputs', () => {
    const result = calc.compute({ weight: 151, height: 140 }) as CalculatorResult | null;
