...
| **P2-PERF-NEW-13** | Gemini fallback chain — sequential, не parallel race | `app/api/diagnostic/route.ts:248-326` | На 429 quota exhaustion: 5 s (2 sequential) → 1.8 s (parallel race). |
