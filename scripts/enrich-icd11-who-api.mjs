// DEPRECATED (Phase 2 era). Используется ИСТОРИЧЕСКИ для обогащения
// существующего simpleTabulation 2018-12. Phase 3 заменил его на полный
// обход дерева через scripts/fetch-icd11-full-tree.mjs (актуальный
// release 2024-01) — он быстрее, точнее и даёт +3000 кодов.
//
// Используйте этот скрипт ТОЛЬКО если работаете с unmodified
// simpleTabulation от WHO 2018-12 и не нужны новые коды.
// ──────────────────────────────────────────────────────────────────
//
