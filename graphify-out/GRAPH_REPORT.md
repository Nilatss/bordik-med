...
## Corpus Check
- 993 files · ~5,165,646 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2266 nodes · 2334 edges · 961 communities (944 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16e84bda`
...
## Communities (961 total, 17 thin omitted)
...
Cohesion: 0.12
Nodes (36): chdir(), chmod(), create(), createDataFile(), createStandardStreams(), destroyNode(), doTruncate(), flagsToPermissionString() (+28 more)

### Community 7 - "Community 7"
Cohesion: 0.08
Nodes (31): close(), closeStream(), createStream(), doMsync(), dupStream(), expandFileStorage(), _fd_close(), _fd_read() (+23 more)
...
Cohesion: 0.16
Nodes (15): close(), closeStream(), expandFileStorage(), _fd_close(), _fd_seek(), fsync(), get_char(), isClosed() (+7 more)
...
- **Why does `fetch()` connect `Community 2` to `Community 32`, `Community 3`, `Community 5`, `Community 14`, `Community 21`, `Community 22`, `Community 56`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 28` to `Community 0`, `Community 2`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 29` to `Community 1`, `Community 2`?**
