...
## Corpus Check
- 971 files · ~1,415,378 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2193 nodes · 2265 edges · 943 communities (926 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57f47f1f`
...
Cohesion: 0.09
Nodes (46): analyzePath(), chdir(), chmod(), create(), createDataFile(), createFile(), createLazyFile(), createNode() (+38 more)
...
Cohesion: 0.12
Nodes (35): chdir(), chmod(), create(), createDataFile(), createFile(), createLazyFile(), destroyNode(), flagsToPermissionString() (+27 more)
...
Cohesion: 0.17
Nodes (9): splitIntoTabs(), getArticle(), getCourseById(), getCourseSearchIndex(), getModuleForCourse(), getModulesBySection(), getSectionById(), searchCourses() (+1 more)
...
Cohesion: 0.4
Nodes (4): escapeMd(), POST(), GET(), pingUpstash()
...
- **Why does `fetch()` connect `Community 8` to `Community 2`, `Community 5`, `Community 50`, `Community 51`, `Community 52`, `Community 29`, `Community 23`, `Community 58`, `Community 27`, `Community 61`, `Community 94`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 51` to `Community 0`, `Community 8`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 52` to `Community 8`, `Community 1`?**
