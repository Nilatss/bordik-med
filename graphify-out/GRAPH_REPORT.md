...
## Corpus Check
- 998 files · ~5,473,449 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2281 nodes · 2346 edges · 970 communities (954 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb157fdc`
...
- `P1-5 /api/sync POST missing assertSameOrigin` --semantically_similar_to--> `P0-SEC-1 GEMINI_API_KEY in query string`  [INFERRED] [semantically similar]
  AUDIT_REPORT_2026-05-06.md → docs/AUDIT_PASS_4_TODO.md
- `Ebbinghaus forgetting curve / Anki` --semantically_similar_to--> `Spaced Repetition (FSRS)`  [INFERRED] [semantically similar]
  tmp-pdf/course_100_1.md → docs/specs/product-audit-2026-05.md
...
## Communities (970 total, 16 thin omitted)
...
Cohesion: 0.02
Nodes (30): convertReturnValue(), fromWireType(), makeBlendComponent(), makeBlendState(), makeBufferEntry(), makeColorAttachment(), makeColorAttachments(), makeColorState() (+22 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (39): triggerExtFetch(), fetchLatestRelease(), onReady(), onWaiting(), readLastSeen(), escapeMd(), POST(), fetch() (+31 more)
...
Cohesion: 0.09
Nodes (46): analyzePath(), chdir(), chmod(), create(), createDataFile(), createNode(), createStandardStreams(), destroyNode() (+38 more)
...
Cohesion: 0.09
Nodes (17): createHandlerBoundToUrl(), d(), er(), fetchDidFail(), getEntryCountByQueueName(), getPrecacheKeyForUrl(), handlerDidError(), M() (+9 more)
...
Cohesion: 0.11
Nodes (21): abort(), assert(), close(), closeStream(), createFile(), createLazyFile(), expandFileStorage(), _fd_close() (+13 more)
...
Cohesion: 0.17
Nodes (16): addEntry(), delete(), deleteCacheAndMetadata(), deleteEntry(), em(), expireEntries(), getAll(), getAllEntriesByQueueName() (+8 more)

### Community 20 - "Community 20"
Cohesion: 0.17
Nodes (5): splitIntoTabs(), getCourseById(), getModuleForCourse(), useT(), useStudyTimer()
...
Cohesion: 0.2
Nodes (7): getModuleById(), getModuleTestSlice(), generateModulePlaceholder(), generatePlaceholder(), getModuleTestQuestions(), getTestQuestions(), hasRealQuestions()
...
Cohesion: 0.21
Nodes (4): isValidEmail(), normalizeLang(), useLang(), commit()
...
Cohesion: 0.23
Nodes (12): Classifications Hub (#3a), Cmd-K global fuzzy search, CR-1 hardcoded '83 pairs' bug, CredibleMeds QT scale, Drug Interaction Checker (K1), ICD-10 Lookup (МКБ-10), K1-Verify (clinical pharmacologist audit), Serwist PWA offline (+4 more)
...
Cohesion: 0.24
Nodes (11): AMBOSS (competitor), Freemium MDCalc-style monetization, ФЗ № 28-ФЗ regulation, MDCalc (competitor), North Star Metric (WAU-врачей), Pediatric Dose Calc (K3), RAG AI Explanations, UpToDate (competitor) (+3 more)

### Community 41 - "Community 41"
Cohesion: 0.38
Nodes (9): cleanTerm(), extractKeyTerms(), extractSentences(), generateContentQuestions(), getCourseTestSlice(), hashString(), looksLikeTerm(), makeRng() (+1 more)

### Community 42 - "Community 42"
Cohesion: 0.29
Nodes (10): _addSyncListener(), addToPrecacheList(), constructor(), el(), ey(), h(), l(), o() (+2 more)

### Community 43 - "Community 43"
Cohesion: 0.31
Nodes (10): cacheMatch(), cachePut(), _ensureResponseSafeToCache(), f(), g(), getCacheKey(), hasCallback(), iterateCallbacks() (+2 more)
...
Cohesion: 0.31
Nodes (9): _addRequest(), clone(), fromRequest(), registerSync(), replayRequests(), shiftRequest(), toObject(), unshiftRequest() (+1 more)
...
Cohesion: 0.32
Nodes (8): getEndEntryFromIndex(), getFirstEntryByQueueName(), getLastEntryByQueueName(), popEntry(), popRequest(), _removeEntry(), _removeRequest(), shiftEntry()
...
Cohesion: 0.33
Nodes (7): _awaitComplete(), destroy(), doneWaiting(), _getResponse(), handleAll(), N(), runCallbacks()
...
Cohesion: 0.33
Nodes (6): cacheDidUpdate(), cachedResponseWillBeUsed(), _getCacheExpiration(), _getDateHeaderTimestamp(), _isResponseDateFresh(), updateTimestamp()
...
- **Why does `fetch()` connect `Community 2` to `Community 3`, `Community 36`, `Community 6`, `Community 43`, `Community 14`, `Community 51`, `Community 22`, `Community 56`, `Community 27`, `Community 63`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 56` to `Community 0`, `Community 2`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 27` to `Community 1`, `Community 2`?**
