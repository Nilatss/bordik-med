...
## Corpus Check
- 985 files · ~1,443,713 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2229 nodes · 2296 edges · 956 communities (941 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c4779d0e`
...
Cohesion: 0.11
Nodes (36): analyzePath(), chdir(), createNode(), destroyNode(), findObject(), flagsToPermissionString(), getMounts(), getPath() (+28 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (34): chdir(), createNode(), createStandardStreams(), destroyNode(), flagsToPermissionString(), getMounts(), getPath(), hashAddNode() (+26 more)
...
Cohesion: 0.17
Nodes (16): cacheDidUpdate(), delete(), deleteCacheAndMetadata(), deleteEntry(), em(), expireEntries(), getAll(), getAllEntriesByQueueName() (+8 more)
...
Cohesion: 0.36
Nodes (9): cacheMatch(), cachePut(), _ensureResponseSafeToCache(), f(), g(), getCacheKey(), iterateCallbacks(), toRequest() (+1 more)
...
- **Why does `fetch()` connect `Community 14` to `Community 3`, `Community 4`, `Community 72`, `Community 46`, `Community 49`, `Community 50`, `Community 61`, `Community 52`, `Community 21`, `Community 53`, `Community 58`, `Community 27`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 52` to `Community 0`, `Community 14`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 53` to `Community 1`, `Community 14`?**
