...
## Corpus Check
- 992 files · ~4,326,167 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2258 nodes · 2324 edges · 954 communities (939 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aec3b9fd`
...
## Communities (954 total, 15 thin omitted)
...
Cohesion: 0.11
Nodes (39): chdir(), chmod(), create(), createDataFile(), createNode(), createStandardStreams(), destroyNode(), doTruncate() (+31 more)
...
Cohesion: 0.13
Nodes (7): useCatalog(), isValidEmail(), normalizeLang(), useLang(), formatStudyTime(), getTotalStudyTime(), commit()
...
Cohesion: 0.19
Nodes (16): calculateAt(), fstat(), getattr(), getStr(), isChrdev(), isDevice(), lstat(), readFile() (+8 more)
...
Cohesion: 0.17
Nodes (15): addEntry(), _addRequest(), clone(), fetchDidFail(), fromRequest(), getFirstEntryId(), pushEntry(), pushRequest() (+7 more)
...
Cohesion: 0.14
Nodes (14): abort(), assert(), createFile(), createLazyFile(), createWasm(), findWasmBinary(), forceLoadFile(), getBinarySync() (+6 more)
...
Cohesion: 0.18
Nodes (11): AUDIT_PASS_4_TODO (29 findings), P0-DEVOPS-1 Sentry+RUM+Uptime, P0-SEC-2 Cascaded fallback timeout, P0-SEC-3 In-memory rate-limit -> Upstash, P0-SEC-4 atomic /api/account/delete RPC, P0-SEC-5 DOMParser output guard, P1-SEC-1 CSP Report-Only -> Enforce, P1-SEC-2 SRI for MediaPipe CDN (+3 more)
...
Cohesion: 0.22
Nodes (10): BACKEND.md Supabase setup, BACKLOG.md post-audit, docs/README.md index, 152-FZ ст.21 24h Roskomnadzor notification, GDPR Art.33 72h notification, supabase/schema.sql (5 tables), Secret rotation schedule, SECURITY_SETUP IR runbook (+2 more)
...
Cohesion: 0.5
Nodes (5): em(), _getId(), getTimestamp(), isURLExpired(), setTimestamp()
...
- **Why does `fetch()` connect `Community 2` to `Community 4`, `Community 7`, `Community 47`, `Community 16`, `Community 53`, `Community 22`, `Community 23`, `Community 28`, `Community 29`?**
  _High betweenness centrality (0.129) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 29` to `Community 0`, `Community 2`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 47` to `Community 1`, `Community 2`?**
