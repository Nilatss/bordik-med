...
## Corpus Check
- 996 files · ~5,418,016 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2277 nodes · 2344 edges · 971 communities (952 shown, 19 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6921ea33`
...
## Communities (971 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (38): calculateMouseCoords(), calculateMouseEvent(), convertReturnValue(), fromWireType(), getMovementX(), getMovementY(), makeBlendComponent(), makeBlendState() (+30 more)
...
Cohesion: 0.09
Nodes (47): analyzePath(), chdir(), createNode(), createStandardStreams(), createStream(), destroyNode(), doTruncate(), findObject() (+39 more)
...
Cohesion: 0.19
Nodes (7): triggerExtFetch(), fetch(), fetchEntity(), findConceptByCode(), getToken(), fetchPublished(), downloadIfMissing()
...
- **Why does `fetch()` connect `Community 27` to `Community 64`, `Community 33`, `Community 3`, `Community 5`, `Community 105`, `Community 106`, `Community 76`, `Community 14`, `Community 49`, `Community 20`, `Community 53`, `Community 54`, `Community 56`, `Community 57`, `Community 28`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 53` to `Community 1`, `Community 27`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 54` to `Community 0`, `Community 27`?**
