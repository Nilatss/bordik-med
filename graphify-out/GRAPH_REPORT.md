...
## Corpus Check
- 985 files · ~1,443,645 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2229 nodes · 2296 edges · 963 communities (943 shown, 20 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 73 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b2f0d055`
...
## Communities (963 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (35): analyzePath(), calculateMouseCoords(), calculateMouseEvent(), convertReturnValue(), findObject(), fromWireType(), getMovementX(), getMovementY() (+27 more)
...
Cohesion: 0.1
Nodes (39): analyzePath(), chdir(), createNode(), createStandardStreams(), destroyNode(), findObject(), flagsToPermissionString(), getMounts() (+31 more)
...
Cohesion: 0.15
Nodes (11): escapeMd(), POST(), fetch(), hasCallback(), GET(), pingUpstash(), fetchEntity(), findConceptByCode() (+3 more)
...
- **Why does `fetch()` connect `Community 12` to `Community 64`, `Community 2`, `Community 3`, `Community 39`, `Community 76`, `Community 21`, `Community 53`, `Community 54`, `Community 55`, `Community 27`, `Community 28`, `Community 61`, `Community 30`, `Community 63`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 55` to `Community 1`, `Community 12`?**
  _High betweenness centrality (0.066) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 30` to `Community 0`, `Community 12`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Are the 18 inferred relationships involving `fetch()` (e.g. with `geminiCall()` and `POST()`) actually correct?**
  _`fetch()` has 18 INFERRED edges - model-reasoned connections that need verification._
