...
## Corpus Check
- 971 files · ~1,414,558 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2193 nodes · 2265 edges · 942 communities (926 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ad83e55`
...
## Communities (942 total, 16 thin omitted)
...
Cohesion: 0.11
Nodes (42): chdir(), chmod(), create(), createDataFile(), createNode(), destroyNode(), doTruncate(), flagsToPermissionString() (+34 more)
...
Cohesion: 0.09
Nodes (24): _addSyncListener(), addToPrecacheList(), constructor(), createHandlerBoundToUrl(), d(), el(), er(), ey() (+16 more)

### Community 6 - "Community 6"
Cohesion: 0.11
Nodes (37): analyzePath(), chdir(), createStream(), destroyNode(), doTruncate(), findObject(), flagsToPermissionString(), getMounts() (+29 more)

### Community 7 - "Community 7"
Cohesion: 0.14
Nodes (25): cacheMatch(), cachePut(), clone(), _ensureResponseSafeToCache(), fetch(), fetchAndCachePut(), findMatchingRoute(), getCacheKey() (+17 more)
...
Cohesion: 0.13
Nodes (20): delete(), deleteCacheAndMetadata(), deleteEntry(), expireEntries(), f(), g(), getAll(), getAllEntriesByQueueName() (+12 more)
...
Cohesion: 0.16
Nodes (19): createDefaultDevices(), createDefaultDirectories(), createDevice(), createNode(), createPath(), createSpecialDirectories(), createStandardStreams(), init() (+11 more)
...
Cohesion: 0.17
Nodes (9): splitIntoTabs(), getCourseById(), getCourseSearchIndex(), getModuleForCourse(), getModulesBySection(), getSectionById(), searchCourses(), useT() (+1 more)
...
Cohesion: 0.17
Nodes (7): fetchLatestRelease(), onReady(), onWaiting(), readLastSeen(), body(), geminiBatch(), PROMPT_FOR_TOPIC()
...
Cohesion: 0.2
Nodes (11): addEntry(), _addRequest(), fetchDidFail(), fromRequest(), getFirstEntryId(), pushEntry(), pushRequest(), registerSync() (+3 more)
...
Cohesion: 0.2
Nodes (10): b(), cacheDidUpdate(), cachedResponseWillBeUsed(), _getCacheExpiration(), _getDateHeaderTimestamp(), handleActivate(), handleCache(), _isResponseDateFresh() (+2 more)
...
- **Why does `fetch()` connect `Community 7` to `Community 2`, `Community 5`, `Community 28`, `Community 49`, `Community 50`, `Community 51`, `Community 23`, `Community 56`, `Community 60`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 50` to `Community 1`, `Community 7`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 51` to `Community 0`, `Community 7`?**
