...
## Corpus Check
- 987 files · ~1,446,117 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2235 nodes · 2301 edges · 958 communities (939 shown, 19 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 74 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9e862629`
...
## Communities (958 total, 19 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (37): analyzePath(), calculateMouseCoords(), calculateMouseEvent(), convertReturnValue(), findObject(), fromWireType(), getMounts(), getMovementX() (+29 more)
...
Cohesion: 0.08
Nodes (25): _addSyncListener(), addToPrecacheList(), cachedResponseWillBeUsed(), constructor(), createHandlerBoundToUrl(), el(), er(), ey() (+17 more)

### Community 4 - "Community 4"
Cohesion: 0.12
Nodes (39): chdir(), chmod(), create(), createDataFile(), createFile(), createNode(), destroyNode(), doTruncate() (+31 more)

### Community 5 - "Community 5"
Cohesion: 0.13
Nodes (36): chdir(), createNode(), createStandardStreams(), destroyNode(), doTruncate(), flagsToPermissionString(), getPath(), hashAddNode() (+28 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (22): triggerExtFetch(), b(), fetch(), fetchAndCachePut(), findMatchingRoute(), _getNetworkPromise(), getPreloadResponse(), _getTimeoutPromise() (+14 more)
...
Cohesion: 0.1
Nodes (25): abort(), assert(), chmod(), close(), closeStream(), create(), createDataFile(), createFile() (+17 more)
...
Cohesion: 0.15
Nodes (18): addEntry(), cacheDidUpdate(), delete(), deleteCacheAndMetadata(), deleteEntry(), em(), expireEntries(), getAll() (+10 more)
...
Cohesion: 0.2
Nodes (7): useCatalog(), getCourseById(), getCourseSearchIndex(), getModuleForCourse(), getModulesBySection(), getSectionById(), searchCourses()
...
Cohesion: 0.19
Nodes (7): isValidEmail(), displayEmoji(), displayLabel(), findOption(), formatStudyTime(), getTotalStudyTime(), commit()
...
Cohesion: 0.27
Nodes (11): createDefaultDevices(), createDefaultDirectories(), createDevice(), createPath(), createSpecialDirectories(), mkdev(), mkdir(), mkdirTree() (+3 more)
...
- **Why does `fetch()` connect `Community 6` to `Community 32`, `Community 96`, `Community 2`, `Community 3`, `Community 97`, `Community 38`, `Community 7`, `Community 49`, `Community 52`, `Community 53`, `Community 54`, `Community 61`, `Community 63`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 53` to `Community 0`, `Community 6`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 54` to `Community 1`, `Community 6`?**
