...
## Corpus Check
- 987 files · ~1,444,767 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2235 nodes · 2301 edges · 956 communities (937 shown, 19 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 74 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `98ec6ed4`
...
## Communities (956 total, 19 thin omitted)
...
Cohesion: 0.11
Nodes (39): chdir(), createNode(), createStandardStreams(), createStream(), destroyNode(), doTruncate(), flagsToPermissionString(), getMounts() (+31 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (21): addEntry(), _addRequest(), addToPrecacheList(), createHandlerBoundToUrl(), el(), er(), fetchDidFail(), fromRequest() (+13 more)
...
Cohesion: 0.11
Nodes (25): triggerExtFetch(), b(), cachePut(), clone(), fetch(), fetchAndCachePut(), findMatchingRoute(), _getNetworkPromise() (+17 more)
...
Cohesion: 0.15
Nodes (9): splitIntoTabs(), useCatalog(), getCourseById(), getCourseSearchIndex(), getModuleForCourse(), getModulesBySection(), getSectionById(), searchCourses() (+1 more)
...
Cohesion: 0.23
Nodes (12): _addSyncListener(), cachedResponseWillBeUsed(), constructor(), ey(), _getCacheExpiration(), _getDateHeaderTimestamp(), h(), _isResponseDateFresh() (+4 more)
...
- **Why does `fetch()` connect `Community 6` to `Community 32`, `Community 96`, `Community 2`, `Community 4`, `Community 7`, `Community 49`, `Community 51`, `Community 52`, `Community 58`, `Community 61`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 51` to `Community 0`, `Community 6`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 52` to `Community 1`, `Community 6`?**
