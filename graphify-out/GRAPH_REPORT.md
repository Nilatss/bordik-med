...
## Corpus Check
- 971 files · ~1,414,942 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2193 nodes · 2265 edges · 944 communities (927 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d546cbc4`
...
## Communities (944 total, 17 thin omitted)
...
Cohesion: 0.08
Nodes (48): analyzePath(), chdir(), create(), createDataFile(), createFile(), createLazyFile(), createNode(), createStandardStreams() (+40 more)
...
Cohesion: 0.09
Nodes (18): createHandlerBoundToUrl(), d(), er(), fetchDidFail(), getEntryCountByQueueName(), getPrecacheKeyForUrl(), handlerDidError(), M() (+10 more)
...
Cohesion: 0.12
Nodes (19): checkOpExists(), chmod(), chown(), doChmod(), doChown(), doSetAttr(), doTruncate(), fchmod() (+11 more)
...
Cohesion: 0.14
Nodes (18): addEntry(), delete(), deleteCacheAndMetadata(), deleteEntry(), em(), expireEntries(), f(), g() (+10 more)
...
Cohesion: 0.26
Nodes (13): calculateAt(), fstat(), getattr(), getStr(), lstat(), stat(), ___syscall_faccessat(), ___syscall_fstat64() (+5 more)
...
- **Why does `fetch()` connect `Community 9` to `Community 96`, `Community 3`, `Community 6`, `Community 49`, `Community 50`, `Community 52`, `Community 21`, `Community 53`, `Community 54`, `Community 59`, `Community 28`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 53` to `Community 1`, `Community 9`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 54` to `Community 0`, `Community 9`?**
