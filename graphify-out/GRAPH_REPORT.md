...
## Corpus Check
- 987 files · ~1,444,730 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2235 nodes · 2301 edges · 956 communities (939 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 74 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b869c86e`
...
## Communities (956 total, 17 thin omitted)
...
Cohesion: 0.09
Nodes (47): analyzePath(), chdir(), chmod(), create(), createDataFile(), createFile(), createNode(), createStandardStreams() (+39 more)
...
Cohesion: 0.08
Nodes (29): _addSyncListener(), addToPrecacheList(), b(), cachedResponseWillBeUsed(), constructor(), createHandlerBoundToUrl(), el(), er() (+21 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (33): close(), closeStream(), createStream(), doMsync(), dupStream(), expandFileStorage(), _fd_close(), _fd_read() (+25 more)

### Community 6 - "Community 6"
Cohesion: 0.14
Nodes (29): chdir(), createPath(), destroyNode(), flagsToPermissionString(), getMounts(), getPath(), hashAddNode(), hashName() (+21 more)
...
Cohesion: 0.1
Nodes (26): abort(), assert(), chmod(), close(), closeStream(), create(), createDataFile(), createFile() (+18 more)
...
Cohesion: 0.12
Nodes (22): addEntry(), cacheDidUpdate(), delete(), deleteCacheAndMetadata(), deleteEntry(), em(), expireEntries(), f() (+14 more)
...
Cohesion: 0.18
Nodes (8): getCourseById(), getCourseSearchIndex(), getModuleForCourse(), getModulesBySection(), getSectionById(), searchCourses(), useT(), useStudyTimer()
...
Cohesion: 0.22
Nodes (16): cacheMatch(), cachePut(), _ensureResponseSafeToCache(), fetchAndCachePut(), getCacheKey(), _getNetworkPromise(), getPreloadResponse(), _getTimeoutPromise() (+8 more)
...
Cohesion: 0.23
Nodes (14): calculateAt(), fstat(), getattr(), getStr(), lstat(), readFile(), stat(), ___syscall_faccessat() (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.21
Nodes (14): createDefaultDevices(), createDefaultDirectories(), createDevice(), createSpecialDirectories(), createStandardStreams(), init(), mkdev(), mkdir() (+6 more)
...
- **Why does `fetch()` connect `Community 13` to `Community 3`, `Community 4`, `Community 7`, `Community 47`, `Community 51`, `Community 20`, `Community 53`, `Community 59`, `Community 28`, `Community 29`, `Community 62`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 29` to `Community 1`, `Community 13`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 53` to `Community 0`, `Community 13`?**
