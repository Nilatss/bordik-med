...
## Corpus Check
- 978 files · ~1,433,741 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2206 nodes · 2271 edges · 949 communities (932 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dbecab9a`
...
## Communities (949 total, 17 thin omitted)
...
Cohesion: 0.08
Nodes (28): _addSyncListener(), addToPrecacheList(), cacheDidUpdate(), cachedResponseWillBeUsed(), constructor(), createHandlerBoundToUrl(), delete(), deleteCacheAndMetadata() (+20 more)

### Community 4 - "Community 4"
Cohesion: 0.13
Nodes (33): chdir(), createNode(), destroyNode(), doTruncate(), flagsToPermissionString(), getMounts(), getPath(), hashAddNode() (+25 more)

### Community 5 - "Community 5"
Cohesion: 0.15
Nodes (30): chdir(), createNode(), destroyNode(), doTruncate(), flagsToPermissionString(), hashAddNode(), hashName(), hashRemoveNode() (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.09
Nodes (30): abort(), assert(), chmod(), close(), closeStream(), create(), createDataFile(), createFile() (+22 more)
...
Cohesion: 0.13
Nodes (11): escapeMd(), POST(), fetch(), GET(), pingUpstash(), fetchPublished(), downloadIfMissing(), loadCatalogMeta() (+3 more)
...
Cohesion: 0.2
Nodes (11): AUDIT_PASS_4_TODO (29 findings), BACKLOG.md post-audit, P0-DEVOPS-1 Sentry+RUM+Uptime, P0-SEC-2 Cascaded fallback timeout, P0-SEC-3 In-memory rate-limit -> Upstash, P0-SEC-4 atomic /api/account/delete RPC, P0-SEC-5 DOMParser output guard, P1-SEC-1 CSP Report-Only -> Enforce (+3 more)
...
- **Why does `fetch()` connect `Community 11` to `Community 32`, `Community 2`, `Community 3`, `Community 34`, `Community 39`, `Community 10`, `Community 52`, `Community 22`, `Community 58`, `Community 61`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 34` to `Community 1`, `Community 11`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 52` to `Community 0`, `Community 11`?**
