...
## Corpus Check
- 992 files · ~5,164,940 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2259 nodes · 2324 edges · 961 communities (943 shown, 18 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad620ee6`
...
## Communities (961 total, 18 thin omitted)
...
Cohesion: 0.12
Nodes (36): chdir(), chmod(), create(), createDataFile(), createFile(), createLazyFile(), createStandardStreams(), destroyNode() (+28 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (14): createHandlerBoundToUrl(), delete(), deleteCacheAndMetadata(), er(), expireEntries(), f(), fetchDidFail(), g() (+6 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (27): chmod(), create(), createDataFile(), createDefaultDevices(), createDefaultDirectories(), createDevice(), createFile(), createNode() (+19 more)
...
Cohesion: 0.18
Nodes (25): chdir(), destroyNode(), doTruncate(), flagsToPermissionString(), hashAddNode(), hashName(), hashRemoveNode(), isDir() (+17 more)
...
- **Why does `fetch()` connect `Community 2` to `Community 3`, `Community 5`, `Community 17`, `Community 52`, `Community 53`, `Community 54`, `Community 24`, `Community 25`, `Community 60`?**
