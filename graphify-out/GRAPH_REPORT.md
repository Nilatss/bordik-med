...
## Corpus Check
- 974 files · ~1,423,400 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2198 nodes · 2267 edges · 948 communities (931 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0038db88`
...
## Communities (948 total, 17 thin omitted)
...
Cohesion: 0.1
Nodes (45): chdir(), chmod(), create(), createDataFile(), createNode(), createPath(), createStandardStreams(), destroyNode() (+37 more)
...
Cohesion: 0.15
Nodes (31): chdir(), createNode(), destroyNode(), flagsToPermissionString(), hashAddNode(), hashName(), hashRemoveNode(), isBlkdev() (+23 more)
...
Cohesion: 0.14
Nodes (24): b(), cacheMatch(), cachePut(), fetch(), fetchAndCachePut(), findMatchingRoute(), getCacheKey(), _getNetworkPromise() (+16 more)
...
Cohesion: 0.12
Nodes (18): createStream(), doMsync(), dupStream(), _fd_read(), _fd_write(), getStreamFromFD(), ioctl(), ioctl_tcgets() (+10 more)
...
Cohesion: 0.32
Nodes (8): _awaitComplete(), destroy(), doneWaiting(), _ensureResponseSafeToCache(), _getResponse(), handleAll(), iterateCallbacks(), runCallbacks()
...
- **Why does `fetch()` connect `Community 10` to `Community 96`, `Community 97`, `Community 2`, `Community 5`, `Community 45`, `Community 47`, `Community 49`, `Community 50`, `Community 51`, `Community 57`, `Community 27`, `Community 60`, `Community 30`, `Community 95`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 50` to `Community 1`, `Community 10`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 51` to `Community 0`, `Community 10`?**
