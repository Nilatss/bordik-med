...
## Corpus Check
- 981 files · ~1,439,724 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2212 nodes · 2274 edges · 955 communities (939 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fb1e1f0f`
...
## Communities (955 total, 16 thin omitted)
...
Cohesion: 0.1
Nodes (44): chdir(), chmod(), create(), createDataFile(), createNode(), createStandardStreams(), destroyNode(), doTruncate() (+36 more)

### Community 4 - "Community 4"
Cohesion: 0.13
Nodes (35): chdir(), createNode(), createStream(), destroyNode(), doTruncate(), flagsToPermissionString(), getPath(), hashAddNode() (+27 more)
...
Cohesion: 0.16
Nodes (9): escapeMd(), POST(), fetch(), getPreloadResponse(), hasCallback(), GET(), pingUpstash(), fetchPublished() (+1 more)

### Community 26 - "Community 26"
Cohesion: 0.2
Nodes (14): b(), fetchAndCachePut(), findMatchingRoute(), _getNetworkPromise(), _getTimeoutPromise(), handle(), handleActivate(), handleCache() (+6 more)
...
Cohesion: 0.36
Nodes (8): _addRequest(), clone(), fromRequest(), registerSync(), replayRequests(), shiftRequest(), toObject(), unshiftRequest()
...
- **Why does `fetch()` connect `Community 25` to `Community 64`, `Community 2`, `Community 5`, `Community 50`, `Community 53`, `Community 54`, `Community 55`, `Community 56`, `Community 26`, `Community 28`, `Community 61`, `Community 30`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 55` to `Community 0`, `Community 25`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 56` to `Community 1`, `Community 25`?**
