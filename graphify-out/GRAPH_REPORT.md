...
## Corpus Check
- 998 files · ~5,473,216 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2281 nodes · 2346 edges · 968 communities (952 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4829417e`
...
## Communities (968 total, 16 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (39): calculateMouseCoords(), calculateMouseEvent(), convertReturnValue(), ExitStatus, fromWireType(), getMovementX(), getMovementY(), makeBlendComponent() (+31 more)
...
Cohesion: 0.1
Nodes (39): analyzePath(), chdir(), create(), createFile(), createNode(), destroyNode(), findObject(), flagsToPermissionString() (+31 more)

### Community 5 - "Community 5"
Cohesion: 0.12
Nodes (34): analyzePath(), chdir(), createStandardStreams(), destroyNode(), doTruncate(), findObject(), flagsToPermissionString(), getMounts() (+26 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (14): createHandlerBoundToUrl(), d(), er(), getPrecacheKeyForUrl(), handlerDidError(), M(), matchPrecache(), N() (+6 more)
...
Cohesion: 0.14
Nodes (17): checkOpExists(), chown(), doChmod(), doChown(), doSetAttr(), doTruncate(), fchmod(), fchown() (+9 more)
...
Cohesion: 0.16
Nodes (16): _addSyncListener(), addToPrecacheList(), cacheDidUpdate(), cachedResponseWillBeUsed(), constructor(), el(), ey(), _getCacheExpiration() (+8 more)
...
Cohesion: 0.2
Nodes (15): create(), createDefaultDevices(), createDefaultDirectories(), createDevice(), createFile(), createPath(), createSpecialDirectories(), mkdev() (+7 more)
...
Cohesion: 0.22
Nodes (14): _awaitComplete(), cacheMatch(), cachePut(), destroy(), doneWaiting(), _ensureResponseSafeToCache(), getCacheKey(), _getResponse() (+6 more)

### Community 30 - "Community 30"
Cohesion: 0.18
Nodes (14): addEntry(), em(), getAll(), getAllEntriesByQueueName(), getDb(), getEntryCountByQueueName(), getFirstEntryId(), _getId() (+6 more)
...
Cohesion: 0.24
Nodes (11): _addRequest(), clone(), fetchDidFail(), fromRequest(), pushRequest(), registerSync(), replayRequests(), shiftRequest() (+3 more)
...
Cohesion: 0.28
Nodes (9): deleteEntry(), getEndEntryFromIndex(), getFirstEntryByQueueName(), getLastEntryByQueueName(), popEntry(), popRequest(), _removeEntry(), _removeRequest() (+1 more)

### Community 50 - "Community 50"
Cohesion: 0.22
Nodes (9): AUDIT_REPORT_2026-05-06, P0-2 740 runners @ts-nocheck, P1-1 aa-grad vs aa-gradient duplicate, P1-3 Scale segments 288 issues, P1-4 SI/US unit conversion not centralized, P1-5 /api/sync POST missing assertSameOrigin, P1-6 Large files split candidates, P0-SEC-1 GEMINI_API_KEY in query string (+1 more)

### Community 51 - "Community 51"
Cohesion: 0.22
Nodes (9): P0-1 GFR Infinity Guard, AUDIT_PASS_4_TODO (29 findings), P0-CQ-1 Golden tests on CRITICAL_TOOL_IDS, P0-DEVOPS-1 Sentry+RUM+Uptime, P0-SEC-2 Cascaded fallback timeout, P0-SEC-4 atomic /api/account/delete RPC, P0-SEC-5 DOMParser output guard, P1-SEC-1 CSP Report-Only -> Enforce (+1 more)
...
Cohesion: 0.4
Nodes (5): delete(), deleteCacheAndMetadata(), expireEntries(), f(), g()
...
- **Why does `fetch()` connect `Community 2` to `Community 32`, `Community 33`, `Community 3`, `Community 6`, `Community 40`, `Community 14`, `Community 22`, `Community 59`, `Community 29`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 32` to `Community 1`, `Community 2`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 33` to `Community 0`, `Community 2`?**
