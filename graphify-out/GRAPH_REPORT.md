...
## Corpus Check
- 994 files · ~5,166,277 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2270 nodes · 2339 edges · 965 communities (947 shown, 18 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 75 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bef26ece`
...
## Communities (965 total, 18 thin omitted)
...
Cohesion: 0.12
Nodes (37): chdir(), create(), createDataFile(), createNode(), destroyNode(), doTruncate(), flagsToPermissionString(), getMounts() (+29 more)
...
Cohesion: 0.09
Nodes (27): abort(), assert(), close(), closeStream(), createWasm(), expandFileStorage(), _fd_close(), _fd_seek() (+19 more)
...
Cohesion: 0.13
Nodes (20): addEntry(), cacheDidUpdate(), delete(), deleteCacheAndMetadata(), deleteEntry(), em(), expireEntries(), f() (+12 more)
...
Cohesion: 0.16
Nodes (8): useCatalog(), getCourseById(), getCourseSearchIndex(), getModuleForCourse(), getModulesBySection(), getSectionById(), searchCourses(), useStudyTimer()
...
Cohesion: 0.13
Nodes (17): checkOpExists(), chmod(), chown(), doChmod(), doChown(), doSetAttr(), fchmod(), fchown() (+9 more)
...
Cohesion: 0.43
Nodes (8): cacheMatch(), cachePut(), _ensureResponseSafeToCache(), getCacheKey(), hasCallback(), iterateCallbacks(), toRequest(), z()
...
Cohesion: 0.5
Nodes (4): cachedResponseWillBeUsed(), _getCacheExpiration(), _getDateHeaderTimestamp(), _isResponseDateFresh()
...
- **Why does `fetch()` connect `Community 2` to `Community 3`, `Community 6`, `Community 7`, `Community 48`, `Community 16`, `Community 52`, `Community 54`, `Community 23`, `Community 59`, `Community 61`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 7` to `Community 0`, `Community 2`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 54` to `Community 1`, `Community 2`?**
