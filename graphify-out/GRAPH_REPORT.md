...
## Corpus Check
- 980 files · ~1,439,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2208 nodes · 2271 edges · 949 communities (934 shown, 15 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8345f4f`
...
## Communities (949 total, 15 thin omitted)
...
Cohesion: 0.08
Nodes (30): _addSyncListener(), addToPrecacheList(), cachedResponseWillBeUsed(), constructor(), createHandlerBoundToUrl(), d(), el(), er() (+22 more)
...
Cohesion: 0.14
Nodes (30): chdir(), destroyNode(), doTruncate(), flagsToPermissionString(), getMounts(), getPath(), hashAddNode(), hashName() (+22 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (28): abort(), assert(), chmod(), close(), closeStream(), create(), createDataFile(), createFile() (+20 more)

### Community 7 - "Community 7"
Cohesion: 0.11
Nodes (27): abort(), assert(), chmod(), close(), closeStream(), create(), createDataFile(), createFile() (+19 more)
...
Cohesion: 0.11
Nodes (13): escapeMd(), POST(), fetch(), getPreloadResponse(), hasCallback(), GET(), pingUpstash(), fetchPublished() (+5 more)

### Community 12 - "Community 12"
Cohesion: 0.16
Nodes (17): fetchLatestRelease(), onReady(), onWaiting(), readLastSeen(), buildSlices(), emitFile(), emitIndex(), findCoursesWithContent() (+9 more)
...
Cohesion: 0.16
Nodes (9): useCatalog(), getCourseById(), getCourseSearchIndex(), getModuleForCourse(), getModulesBySection(), getSectionById(), searchCourses(), formatStudyTime() (+1 more)

### Community 17 - "Community 17"
Cohesion: 0.2
Nodes (17): b(), cachePut(), clone(), fetchAndCachePut(), findMatchingRoute(), _getNetworkPromise(), _getTimeoutPromise(), handle() (+9 more)
...
Cohesion: 0.15
Nodes (14): createStream(), dupStream(), _fd_read(), _fd_seek(), _fd_write(), getStreamFromFD(), ioctl(), ioctl_tcgets() (+6 more)
...
Cohesion: 0.22
Nodes (13): createDefaultDevices(), createDefaultDirectories(), createDevice(), createPath(), createSpecialDirectories(), createStandardStreams(), init(), mkdev() (+5 more)

### Community 31 - "Community 31"
Cohesion: 0.23
Nodes (12): _awaitComplete(), cacheMatch(), destroy(), doneWaiting(), _ensureResponseSafeToCache(), getCacheKey(), _getResponse(), handleAll() (+4 more)
...
Cohesion: 0.22
Nodes (9): _addRequest(), fetchDidFail(), fromRequest(), pushRequest(), registerSync(), replayRequests(), shiftRequest(), toObject() (+1 more)
...
- **Why does `fetch()` connect `Community 11` to `Community 2`, `Community 3`, `Community 12`, `Community 47`, `Community 17`, `Community 54`, `Community 55`, `Community 60`, `Community 62`, `Community 31`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 54` to `Community 1`, `Community 11`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 55` to `Community 0`, `Community 11`?**
