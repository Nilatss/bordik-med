...
## Corpus Check
- 978 files · ~1,433,486 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2206 nodes · 2271 edges · 950 communities (931 shown, 19 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 69 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `051556ba`
...
Cohesion: 0.08
Nodes (27): _addSyncListener(), addToPrecacheList(), b(), cachedResponseWillBeUsed(), constructor(), createHandlerBoundToUrl(), el(), er() (+19 more)
...
Cohesion: 0.08
Nodes (33): close(), closeStream(), create(), createDataFile(), doMsync(), dupStream(), expandFileStorage(), _fd_close() (+25 more)
...
Cohesion: 0.12
Nodes (19): addEntry(), _addRequest(), fromRequest(), getEndEntryFromIndex(), getFirstEntryByQueueName(), getFirstEntryId(), getLastEntryByQueueName(), popEntry() (+11 more)
...
Cohesion: 0.18
Nodes (12): _awaitComplete(), destroy(), doneWaiting(), _getResponse(), handleAll(), M(), N(), q() (+4 more)
...
Cohesion: 0.31
Nodes (11): calculateAt(), getStr(), lstat(), readFile(), stat(), ___syscall_faccessat(), ___syscall_lstat64(), ___syscall_newfstatat() (+3 more)
...
- **Why does `fetch()` connect `Community 8` to `Community 2`, `Community 3`, `Community 11`, `Community 60`, `Community 15`, `Community 51`, `Community 52`, `Community 95`, `Community 58`, `Community 28`, `Community 93`, `Community 94`, `Community 31`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 52` to `Community 0`, `Community 8`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 28` to `Community 8`, `Community 1`?**
