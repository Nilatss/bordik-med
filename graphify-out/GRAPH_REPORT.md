...
## Corpus Check
- 986 files · ~1,444,279 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2233 nodes · 2300 edges · 955 communities (939 shown, 16 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 74 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ce4371c`
...
Cohesion: 0.13
Nodes (35): chdir(), chmod(), create(), createDataFile(), createFile(), createStandardStreams(), destroyNode(), doTruncate() (+27 more)
...
Cohesion: 0.08
Nodes (28): abort(), assert(), close(), closeStream(), createLazyFile(), createWasm(), expandFileStorage(), _fd_close() (+20 more)
...
Cohesion: 0.12
Nodes (12): triggerExtFetch(), escapeMd(), POST(), fetch(), getPreloadResponse(), GET(), pingUpstash(), fetchEntity() (+4 more)
...
Cohesion: 0.22
Nodes (8): fetchLatestRelease(), onReady(), onWaiting(), readLastSeen(), fetchEntity(), getToken(), processOne(), save()
...
Cohesion: 0.36
Nodes (9): cacheMatch(), cachePut(), _ensureResponseSafeToCache(), getCacheKey(), hasCallback(), iterateCallbacks(), toRequest(), w() (+1 more)
...
- **Why does `fetch()` connect `Community 12` to `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 45`, `Community 60`, `Community 50`, `Community 53`, `Community 62`, `Community 28`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 6` to `Community 0`, `Community 12`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `instantiateAsync()` connect `Community 7` to `Community 1`, `Community 12`?**
