...
export default function DiagnosticTest({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      ...
      {/* AI-content disclaimer - mandatory for medical-education quizzes
          generated by LLMs. Tells the user this is study material and not
      ...
      <div style={{
        ...
        <svg width={16} height={16} viewBox="0 0 24 24" fill="none"
          stroke="#92400E" strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round"
        ...
        <p style={{
          ...
          Вопросы генерируются AI (Google Gemini) и могут содержать неточности.
          Это <strong>учебный материал</strong>, не клиническая рекомендация.
          Заметили ошибку — напишите нам через «Обратную связь» в сайдбаре.
        </p>
      </div>
